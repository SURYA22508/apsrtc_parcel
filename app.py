...
SUPABASE_URL="https://seigqweqplmuqavquanf.supabase.co"
SUPABASE_KEY = "sb_publishable_Pg8moHOFTgFd9BG927g_yQ_pA63DTdn"
...
def order_page():
    ...
    url = "https://apsrtc-algo-api.onrender.com/route"
    # -------------------------------
    # Page Config
    # -------------------------------
    ...
    if st.button("Track Order"):
        ...
        if not order_id:
            ...
            try:
                ...
                # ✅ then style / use
                styled_path_df = style_dataframe(df)
                #st.dataframe(styled_path_df[["Source", "Destination", "Start Time", "Scheduled Arrival"]], use_container_width=True)   # ✅ shows in UI
                # Load data
                
                # Extract required columns
                df = styled_path_df[["Source", "Destination", "Start Time", "Scheduled Arrival"]]
            ...
            if doc_id:
                source=styled_path_df[styled_path_df['Service ID'] == doc_id]['Source'].iloc[0]
                destination=styled_path_df[styled_path_df['Service ID'] == doc_id][ 'Destination'].iloc[0]
